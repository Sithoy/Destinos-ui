...
# Public inquiries are saved before notifications are processed by the scheduled command.
...
EMAIL_TIMEOUT = 15
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "contact@dpmundo.com")
